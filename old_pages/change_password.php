...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Organization Change Password - Bandhan</title>
									...
									<div class="col-xs-12 col-sm-4" >
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Organization Change Password</h4>
													<!-------
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div style="padding-bottom:20px">
															...
															<input type="password" class="form-control" id="form-field-8" placeholder="Enter Old Password" name="pass" />
														</div>
...
if(isset($_POST['btn_update']))
{
	 ...
	 $query = 'select * from tbl_organization where  org_password=MD5("'.$_POST['pass'].'")and id ="'.$_SESSION['org_id'].'" ';
...
if(strlen($_POST['pass1']) >= 5 )
	{
		...
		{
		$query1='update tbl_organization set org_password=MD5("'.$_POST['pass1'].'") where id ="'.$_SESSION['org_id'].'" ';	

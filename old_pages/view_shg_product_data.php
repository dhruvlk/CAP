...
<table id="example" class="display nowrap table-bordered table-hover" cellspacing="0" width="100%">
      <thead>
		...
		$query="SELECT tbl_add_shg.shg_group_name,shg_product_detail.img,shg_product_detail.product_id,shg_product_detail.product_name,shg_product_detail.product_category,shg_product_detail.contact_person,shg_product_detail.contact_no,shg_product_detail.enabler_id,tbl_enabler.enabler_name,tbl_enabler.id FROM tbl_add_shg,shg_product_detail,tbl_enabler  where tbl_add_shg.shg_id=shg_product_detail.shg_id and shg_product_detail.org_id='".$_SESSION['org_id']."'and shg_product_detail.enabler_id='".$_GET['id']."' and tbl_enabler.id=shg_product_detail.enabler_id ";
		...
		?>
			...
			<td>
				<div>
				    ...
				    <?php /*?><a href="details.php?id=<?php echo $product_id; ?>&enabler_id=<?php echo $enabler_id; ?>" class="iframe_profile" title="View Product Details"><i class="ace-icon fa fa-eye bigger-130"></i></a>&nbsp;&nbsp;<?php */?>

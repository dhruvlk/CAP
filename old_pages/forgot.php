...
//$db = new mysqli('localhost', 'root', '', 'db_bandhan');
    if($_GET['id']!="" && $_GET['key']!=""):
        $org_id=mysqli_real_escape_string($con,$_GET['id']);
        $active_code=mysqli_real_escape_string($con,$_GET['key']);
        $fetch=mysqli_query($con,"SELECT * FROM `tbl_organization` WHERE id='$org_id' AND `active_code` = '$active_code'");
	...
	<body class="login-layout light-login">
        ...
        <form method="post" autocomplete="off" id="password_form">
          ...
          <div id="error_result"></div>
            <input type="hidden" name="id" value="<?php echo $org_id; ?>" id="id">
...
<script>  
  $(document).ready(function(){
    $(document).on('click','#btn-pwd',function(){
      var url = "new_password_forgot.php";       

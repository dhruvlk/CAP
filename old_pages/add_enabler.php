			...
			<div class="main-content">
				<div class="main-content-inner">
								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<form class="form-horizontal" role="form" method="post">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Enabler Name <span style="color:red">&nbsp;&nbsp;*</span></label>

											<div class="col-sm-9">
												<input type="text" id="form-field-1" name="enabler_name" placeholder="Enter Enabler Full Name" class="col-xs-10 col-sm-5" pattern="[A-Za-z\s]+" title="Characters Only" required />
											</div>
									    </div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="form-field-1" name="enabler_mno" maxlength="10" placeholder="Enter 10 Digit Mobile No. Start With 7,8,9" class="col-xs-10 col-sm-5"  pattern="[7-9]{1}[0-9]{9}" title="Only Number Start With 7,8,9"required />
											</div>
									    </div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="email" id="username" name="enabler_email"  placeholder="xyz@email.com" class="col-xs-10 col-sm-5" onblur="return check_username();" required />
					...
					<span id="Loading"><img src="loader.gif" alt="" /></span>
								...
								<input type="hidden" class="col-xs-10 col-sm-5" id="exampleInputPassword1" placeholder="Order No" name="enabler_id" value="<?php $qury=mysqli_query($con,"SELECT id from tbl_enabler ORDER BY id DESC LIMIT 1");
...
confirm_password.onkeyup = validatePassword;
									...
									{
									extract($_POST);
									$query="insert into tbl_enabler(org_id,enabler_name,enabler_mno,enabler_email,date_of_joining,org_name,enabler_creation_timestamp)values('".$_SESSION['org_id']."','$enabler_name','$enabler_mno','$enabler_email','$date_of_joining','".$_SESSION['org_name']."',NOW())";
									$res=mysqli_query($con,$query);
									if($res)
									  {
									  
									
  if($_POST['enabler_email']!=""):
    
     
         
         $active_code=md5(uniqid(rand(5, 15), true));
         $link = 'http://localhost/updated_bandhan/updated_bandhan(20-3-17)/fchangepass.php?enabler_id='.$_POST['enabler_id'].'&key='.$active_code;         
         $fetch=mysqli_query($con,"UPDATE `tbl_enabler` SET `active_code` = '$active_code' WHERE `enabler_email`='$enabler_email' ");
         $to="$enabler_email"; //change to ur mail address
         $strSubject="Bandhan | Password  Link";
      ...
      header("Location:add_enabler.php");
  endif;
									    ...
									    echo "<script>";
										echo "alert('Enabler Register Successfully');";
										echo "window.location.href='add_enabler.php';";
										echo "</script>";
									  }
									  else
									  {
									    echo "<script>";
										echo "alert('Error! Enabler Not Register');";
										echo "window.location.href='add_enabler.php';";
										echo "</script>";
									  }
									}

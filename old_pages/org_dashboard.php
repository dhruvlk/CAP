...
//session_start();
	//-------------------------------------Producer Non-Producer-------------------------
													...
													$producer="select * from tbl_add_shg where NOT shg_current_activity = 'No' and org_id='".$_SESSION['org_id']."' and delete_status='Active'";
													$res=mysqli_query($con,$producer) or die(mysqli_error($con));
													$producer_count=mysqli_num_rows($res);
													//echo $producer_count;
													?>
													<?php
													$nonproducer="select * from tbl_add_shg where  shg_current_activity = 'No' and org_id='".$_SESSION['org_id']."'and delete_status='Active'";
													...
													?>
													 <?php
         $dataPoints = array(
            array("y" => $producer_count, "name" => "Number Of Producer SHG","url"=> "view_producer_shg.php"),
			array("y" => $nonproducer_count, "name" => "Number Of Non Producer SHG","url"=> "view_noproducer_shg.php"),
		...
		//-------------------------------------Bank Linkage-------------------------
													$bank_linkage="select * from tbl_add_shg where NOT shg_bank_linkage = 'No' and org_id='".$_SESSION['org_id']."'and delete_status='Active'";
													$res=mysqli_query($con,$bank_linkage) or die(mysqli_error($con));
													$bank_linkage=mysqli_num_rows($res);
													//echo $bank_linkage;
													?>
													<?php
													$nobank_linkage="select * from tbl_add_shg where  shg_bank_linkage = 'No' and org_id='".$_SESSION['org_id']."'and delete_status='Active'";
													...
													?>
													 <?php
        $dataPoints2 = array(
            array("y" => $bank_linkage, "name" => "SHG With Bank Linkage","url"=> "view_bank_linkage_shg.php"),
			array("y" => $nobank_linkage, "name" => "SHG Without Bank Linkage","url"=> "view_nobank_linkage_shg.php"),
		...
		//-------------------------------------Skill Training-------------------------
												...
												$skill_training="select * from tbl_add_shg where NOT skill_training = 'No' and org_id='".$_SESSION['org_id']."'and delete_status='Active'";
													$res=mysqli_query($con,$skill_training) or die(mysqli_error($con));
													$skill_training_count=mysqli_num_rows($res);
													//echo $producer_count;
													?>
													<?php
													$noskill_training="select * from tbl_add_shg where  skill_training = 'No' and org_id='".$_SESSION['org_id']."'and delete_status='Active'";
												...
												//	echo $producer_count;
													?>
													 <?php
       $dataPoints3 = array(
            array("y" => $skill_training_count, "name" => "SHG With Skill Training","url"=> "view_skilltraining_shg.php"),
			array("y" => $nonskill_training_count, "name" => "SHG Without Skill Training","url"=> "view_noskilltraining_shg.php"),
...
//-------------------------------------Market Linkage-------------------------
													$market_linkage="select * from tbl_add_shg where NOT shg_market_linkage = 'No' and org_id='".$_SESSION['org_id']."'and delete_status='Active'";
													$res=mysqli_query($con,$market_linkage) or die(mysqli_error($con));
													$market_linkage=mysqli_num_rows($res);
													//echo $bank_linkage;
													?>
													<?php
													$nomarket_linkage="select * from tbl_add_shg where  shg_market_linkage = 'No' and org_id='".$_SESSION['org_id']."'and delete_status='Active'";
													...
													?>
													 <?php
        $dataPoints4 = array(
            array("y" => $market_linkage, "name" => "SHG With Market Linkage","url"=> "view_marketlinkage_shg.php"),
			array("y" => $nomarket_linkage, "name" => "SHG Without Market Linkage","url"=> "view_nomarketlinkage_shg.php"),
...
<?php
														...
														$basic_concept_shg="select basic_concept from tbl_add_shg where org_id='".$_SESSION['org_id']."' and basic_concept='Yet_to_start' and delete_status='Active'";
														$res=mysqli_query($con,$basic_concept_shg) or die(mysqli_error($con));
														$basic_concept_shg_count=mysqli_num_rows($res);


$basic_concept_shg1="select basic_concept from tbl_add_shg where org_id='".$_SESSION['org_id']."' and basic_concept='Beginner' and delete_status='Active'";
														$res1=mysqli_query($con,$basic_concept_shg1) or die(mysqli_error($con));
														$basic_concept_shg_count1=mysqli_num_rows($res1);
														$basic_concept_shg2="select basic_concept from tbl_add_shg where org_id='".$_SESSION['org_id']."' and basic_concept='Intermediate' and delete_status='Active'";
														$res2=mysqli_query($con,$basic_concept_shg2) or die(mysqli_error($con));
														$basic_concept_shg_count2=mysqli_num_rows($res2);
														$basic_concept_shg3="select basic_concept from tbl_add_shg where org_id='".$_SESSION['org_id']."' and basic_concept='Literate' and delete_status='Active'";
														...
														<?php
																		$dataPoints = array(
																			array("y" => $basic_concept_shg_count, "label" => "Yet To Start" ,"url"=> "yet_to_start.php"),
																			array("y" => $basic_concept_shg_count1, "label" => "Beginner","url"=> "beginner.php"),
																			array("y" => $basic_concept_shg_count2, "label" => "Intermediate","url"=> "intermediate.php"),
																			array("y" => $basic_concept_shg_count3, "label" => "Literate","url"=> "literate.php"),
...
<?php
														$financial_literacy_shg="select financial_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and financial_literacy='Yet_to_start' and delete_status='Active'";
														$res=mysqli_query($con,$financial_literacy_shg) or die(mysqli_error($con));
														$financial_literacy_shg_count=mysqli_num_rows($res);


$financial_literacy_shg1="select financial_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and financial_literacy='Beginner' and delete_status='Active'";
														$res1=mysqli_query($con,$financial_literacy_shg1) or die(mysqli_error($con));
														$financial_literacy_shg_count1=mysqli_num_rows($res1);
														$financial_literacy_shg2="select financial_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and financial_literacy='Intermediate' and delete_status='Active'";
														$res2=mysqli_query($con,$financial_literacy_shg2) or die(mysqli_error($con));
														$financial_literacy_shg_count2=mysqli_num_rows($res2);
														$financial_literacy_shg3="select financial_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and financial_literacy='Literate' and delete_status='Active'";
														...
														<?php
																		$dataPoints1 = array(
																			array("y" => $financial_literacy_shg_count, "label" => "Yet To Start" ,"url"=> "financial_yet_to_start.php"),
																			array("y" => $financial_literacy_shg_count1, "label" => "Beginner","url"=> "financial_beginner.php"),
																			array("y" => $financial_literacy_shg_count2, "label" => "Intermediate","url"=> "financial_intermediate.php"),
																			array("y" => $financial_literacy_shg_count3, "label" => "Literate","url"=> "financial_literate.php"),
...
<div class="space-20"></div>
<?php
														$functional_literacy_shg="select functional_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and functional_literacy='Yet_to_start' and delete_status='Active'";
														$res=mysqli_query($con,$functional_literacy_shg) or die(mysqli_error($con));
														$functional_literacy_shg_count=mysqli_num_rows($res);


$functional_literacy_shg1="select functional_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and functional_literacy='Beginner' and delete_status='Active'";
														...
														$functional_literacy_shg2="select functional_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and functional_literacy='Intermediate' and delete_status='Active'";
														...
														$functional_literacy_shg3="select functional_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and functional_literacy='Literate' and delete_status='Active'";
														...
														<?php
																		$dataPoints2 = array(
																			array("y" => $functional_literacy_shg_count, "label" => "Yet To Start" ,"url"=> "functional_yet_to_start.php"),
																			array("y" => $functional_literacy_shg_count1, "label" => "Beginner" ,"url"=> "functional_beginner.php"),
																			array("y" => $functional_literacy_shg_count2, "label" => "Intermediate" ,"url"=> "functional_intermediate.php"),
																			array("y" => $functional_literacy_shg_count3, "label" => "Literate" ,"url"=> "functional_literate.php"),
...
<?php
														$business_development_shg="select business_development from tbl_add_shg where org_id='".$_SESSION['org_id']."' and business_development='Yet_to_start' and delete_status='Active'";
														$res=mysqli_query($con,$business_development_shg) or die(mysqli_error($con));
														$business_development_shg_count=mysqli_num_rows($res);


$business_development_shg1="select business_development from tbl_add_shg where org_id='".$_SESSION['org_id']."' and business_development='Beginner' and delete_status='Active'";
														...
														$business_development_shg2="select business_development from tbl_add_shg where org_id='".$_SESSION['org_id']."' and business_development='Intermediate' and delete_status='Active'";
														...
														$business_development_shg3="select business_development from tbl_add_shg where org_id='".$_SESSION['org_id']."' and business_development='Literate' and delete_status='Active'";
														...
														<?php
																		$dataPoints3 = array(
																			array("y" => $business_development_shg_count, "label" => "Yet To Start","url"=> "business_yet_to_start.php"),
																			array("y" => $business_development_shg_count1, "label" => "Beginner","url"=> "business_beginner.php"),
																			array("y" => $business_development_shg_count2, "label" => "Intermediate","url"=> "business_intermediate.php"),
																			array("y" => $business_development_shg_count3, "label" => "Literate","url"=> "business_literate.php"),
                    ...
                    events: {
                        click: function () {
                            location.href = this.options.url;
													...
													<script src="https://code.highcharts.com/modules/drilldown.js"></script>
														<?php
														$basic_concept_shg="select basic_concept from tbl_add_shg where org_id='".$_SESSION['org_id']."' and basic_concept='Yes' and delete_status='Active'";
														$res=mysqli_query($con,$basic_concept_shg) or die(mysqli_error($con));
														$basic_concept_shg_count=mysqli_num_rows($res);


														$financial_literacy="select financial_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and financial_literacy='Yes' and delete_status='Active'";
														$res1=mysqli_query($con,$financial_literacy) or die(mysqli_error($con));
														$financial_literacy_count=mysqli_num_rows($res1);

														$functional_literacy="select functional_literacy from tbl_add_shg where org_id='".$_SESSION['org_id']."' and functional_literacy='Yes' and delete_status='Active'";
														$res2=mysqli_query($con,$functional_literacy) or die(mysqli_error($con));
														$functional_literacy_count=mysqli_num_rows($res2);

														$business_development="select business_development from tbl_add_shg where org_id='".$_SESSION['org_id']."' and business_development='Yes' and delete_status='Active'";

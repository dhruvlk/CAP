...
<table id="example" class="display nowrap table-bordered table-hover" cellspacing="0" width="100%">
      <thead>
		...
		$query="select * from tbl_add_shg where org_id='".$_SESSION['org_id']."' and basic_concept='Yes' and financial_literacy='Yes' and functional_literacy='Yes' and business_development='Yes'";

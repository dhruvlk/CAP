...
<table id="example" class="display nowrap table-bordered table-hover" cellspacing="0" width="100%">
      <thead>
		...
		$query="select e.enabler_name,e.id,s.shg_id,s.shg_group_name,s.total_member,s.shg_formation_date,s.shg_current_activity,s.shg_taluka,s.shg_village_name,s.shg_market_linkage from tbl_enabler e,tbl_add_shg s where s.shg_status='BPL' and s.org_id='".$_SESSION['org_id']."'  and s.delete_status='Active' and e.id=s.enabler_id" ;

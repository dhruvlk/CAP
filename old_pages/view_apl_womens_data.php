...
<table id="example" class="display nowrap table-bordered table-hover" cellspacing="0" width="100%">
        ...
        <tbody>
            <?php
		$query="select m.member_name,m.member_dob,m.member_mno,m.member_caste,m.member_category,m.delete_status,s.shg_group_name from member_details m,tbl_add_shg s where m.shg_id=s.shg_id and m.org_id='".$_SESSION['org_id']."' and m.member_category='APL'and m.enabler_id='".$_GET['id']."' and m.delete_status='Active'";

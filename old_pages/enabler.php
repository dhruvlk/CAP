		...
		?>
            <tr>
				<td>
				    ...
				    <a class="blue" href="enabler_dashboard.php?id=<?php echo $id; ?>&enabler_name=<?php echo $enabler_name;?>"   title="View">
						<i class="menu-icon fa fa-tachometer bigger-130"></i>
					</a>&nbsp;&nbsp;
					<a class="green" href="edit_enabler.php?id=<?php echo $id; ?>" title="Edit">
						<i class="ace-icon fa fa-pencil bigger-130"></i>
					</a>&nbsp;&nbsp;
					<a class="red" onClick="return confirm('Are You Sure You Want To Deactivate This Enabler ?');"  href="delete_enabler.php?id=<?php echo $id; ?>" title="Deactivate">
				...
				{
				?>
                <td style="color:Green"><?php echo $profile_status ?></td>
                 <?php
				}
				else
				{
				?>
				 <td style="color:Red"><?php echo $profile_status ?></td>
				<?php
				}
				 ?>

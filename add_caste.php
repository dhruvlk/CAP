										...
										<div class="col-xs-12">
											...
											<div class="page-header">
												...
												if(isset($_POST['btn_rgister']))
												{
													...
													$queryreg=mysqli_query($con,"insert into caste_reg (cas_name) values ('$cas_name')") or die(mysqli_error($con));
													if($queryreg)
													{

												echo "<script>";
												echo "alert('New Caste Registerd Successfully ');";
												echo "window.location.href='add_caste.php';";
												echo "</script>";
												}
												else
												{
												echo "<script>";
												echo 'alert("Caste Not Registerd");';
												echo "window.location.href='add_caste.php';";
												echo "</script>";
												}
												}

...
<table width="100%" border="1" cellspacing="0" class="display nowrap table-bordered table-hover" id="example">
        ...
        <tbody>
		<?php
		$query="select * from college_reg where c_approve_status='Not_Approved' ORDER BY c_id DESC ";
...
<i class="ace-icon glyphicon glyphicon-th-list bigger-130"></i>
					...
					&nbsp;										
					<a class="blue" onClick="return confirm('Are You Sure You Want To Approve This College ?');" href="approve_college.php?c_id=<?php echo $c_id; ?>" title="Approve College">

...
<table width="100%" border="1" cellspacing="0" class="display nowrap table-bordered table-hover" id="example">
        ...
        <tbody>
		<?php
		$query="select * from caste_reg ORDER BY cas_id DESC ";
		...
		<tr>
				...
				<td><?php echo $cas_name; ?></td>				
				<td align="center">
															
					
					<a class="green" href="edit_caste.php?cas_id=<?php echo $cas_id; ?>" title="Edit Caste">
<i class="ace-icon glyphicon glyphicon-edit bigger-130"></i>
					</a>
					&nbsp;
					<a class="red" onClick="return confirm('Are You Sure You Want To Delete This Caste ?');"  href="delete_caste.php?cas_id=<?php echo $cas_id; ?>" title="Delete Caste">

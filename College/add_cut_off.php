								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<form class="form-horizontal" role="form" method="post">
									    ...
									    <div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="form-field-1" name="c_min_per" placeholder="Enter Minimum Percentage" class="col-xs-10 col-sm-5"  title="Characters Only" required />
											</div>
									    </div>
									    ...
									    <div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="form-field-1" name="c_max_per" placeholder="Enter Maximum Percentage" class="col-xs-10 col-sm-5"  title="Characters Only" required />
											</div>
									    </div>
									    ...
									    <div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="form-field-1" name="c_ac_year" placeholder="Enter Academic Year (Ex. 2017-2018 )" class="col-xs-10 col-sm-5"   required />
											</div>
									    </div>
									...
									if(isset($_POST['btn_rgister']))
									{
										...
										$queryreg=mysqli_query($con,"insert into cut_off_reg (c_col_email,c_col_name,c_col_code,c_col_district,c_dept_name,c_cas_name,c_min_per,c_max_per,c_ac_year) values ('".$_SESSION['c_email']."','".$_SESSION['c_name']."','".$_SESSION['c_code']."','".$_SESSION['c_district']."','$c_dept_name','$c_cas_name','$c_min_per','$c_max_per','$c_ac_year')") or die(mysqli_error($con));

										if($queryreg)
										{
											
											echo "<script>";
											echo "alert('New Cut Off Added Successfully');";
											echo "window.location.href='add_cut_off.php';";
											echo "</script>";																		
										}
										else
										{
											echo "<script>";
											echo 'alert("Cut Off Not Added");';
											echo "window.location.href='add_cut_off.php';";
											echo "</script>";
										}
									}

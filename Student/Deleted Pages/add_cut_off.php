							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									if(isset($_POST['btn_rgister']))
									{
										...
										$queryreg=mysqli_query($con,"insert into cut_off_reg (c_col_email,c_col_name,c_col_code,c_dept_name,c_cas_name,c_min_per,c_max_per,c_ac_year) values ('".$_SESSION['c_email']."','".$_SESSION['c_name']."','".$_SESSION['c_code']."','$c_dept_name','$c_cas_name','$c_min_per','$c_max_per','$c_ac_year')") or die(mysqli_error($con));

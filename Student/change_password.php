									...
									<div class="col-xs-12 col-sm-4" >
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Student Change Password</h4>
													<!-------
...
if(isset($_POST['btn_update']))
{
	 ...
	 $query = 'select * from student_reg where  s_password="'.$_POST['pass'].'" and s_id ="'.$_SESSION['s_id'].'" ';
...
if(strlen($_POST['pass1']) >= 3 )
	{
		...
		{
		$query1='update student_reg set s_password="'.$_POST['pass1'].'" where s_id ="'.$_SESSION['s_id'].'" ';	

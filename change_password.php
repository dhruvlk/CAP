									...
									<div class="col-xs-12 col-sm-4" >
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Admin Change Password</h4>
													<!----
...
if(isset($_POST['btn_update']))
{
	 ...
	 $query = 'select * from admin_login where  a_password="'.$_POST['pass'].'" and id ="'.$_SESSION['id'].'" ';
...
if(strlen($_POST['pass1']) >= 5 )
	{
		...
		{
		$query1='update admin_login set a_password="'.$_POST['pass1'].'" where id ="'.$_SESSION['id'].'" ';

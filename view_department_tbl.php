...
<table width="100%" border="1" cellspacing="0" class="display nowrap table-bordered table-hover" id="example">
        ...
        <tbody>
		<?php
		$query="select * from dept_reg ORDER BY d_id DESC ";
		...
		<tr>
				...
				<td align="center">
					...
					<a class="green"  href="edit_department.php?d_id=<?php echo $d_id; ?>" title="Edit Department">
<i class="ace-icon glyphicon glyphicon-edit bigger-130"></i>
					</a>
					&nbsp;
					<a class="red" onClick="return confirm('Are You Sure You Want To Delete This Department ?');"  href="delete_department.php?d_id=<?php echo $d_id; ?>" title="Delete Department">
